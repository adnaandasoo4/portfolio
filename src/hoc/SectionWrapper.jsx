 ...
 * Default sections are constrained to `max-w-[1800px]` (1536px) and centered —
 ...
 * @param {boolean} [options.fullBleed=false] - When true, drops the `max-w-[1800px]
...
const SectionWrapper = (Component, idName, options) => {
  ...
  return function HOC() {
    ...
    const className = fullBleed
      ? "relative z-0"
      : "sm:px-16 px-6 sm:py-16 py-10 max-w-[1800px] mx-auto relative z-0";
